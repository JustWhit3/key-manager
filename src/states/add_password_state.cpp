...
namespace kmanager::state {
     ...
     */
    AddPasswordState::AddPasswordState(QWidget *host, QState *parent) : BaseState(parent), host(host) {
        // Create widgets
        this->addWidgets();
    ...
    void AddPasswordState::addWidgets() {
        ...
        this->create_new_password_label = QSharedPointer<QLabel>(new QLabel(this->host));
        ...
        this->create_new_password_label->move(this->create_new_password_label->geometry().x() + 30.f,
        ...
        this->password_textbox->resize(this->password_label->geometry().width() * 1.75f,
                                       this->password_label->geometry().height());
        this->password_textbox->setStyleSheet(widget_font_size);
        this->password_textbox->move(this->password_label->geometry().x() + 200.f,
        ...
        this->save_button->move(this->save_button->geometry().x() + 515.f, this->save_button->geometry().y() + 25.f);
        QObject::connect(this->save_button.get(), SIGNAL(clicked()), this, SLOT(savePassword()));
        ...
        this->error_label->move(this->password_label->geometry().x(), this->password_label->geometry().y() + 53.f);
    }
    ...
    void AddPasswordState::savePassword() {
        ...
        this->main_container.insert("Password",
                                    QJsonValue::fromVariant(QString::fromStdString(crypto_password.encrypt())));
        this->main_container.insert("Username",
        ...
        this->main_container.insert(
            "Strength", QJsonValue::fromVariant(this->evaluatePasswordStrength(this->new_password.password_str)));
        ...
        this->file_oss << QStandardPaths::writableLocation(QStandardPaths::AppDataLocation).toStdString()
                       ...
                       << this->new_password.username.toStdString() << ".json";
        ...
        if (this->new_password.platform.isEmpty() || this->new_password.username.isEmpty() ||
