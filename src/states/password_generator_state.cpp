    ...
    void PasswordGeneratorState::addWidgets(){
        ...
        this -> password_generator_label -> move(
            ...
            ( this -> host -> host -> mapToGlobal( this -> host -> host -> geometry().center() ).y() - 
                this -> password_generator_label -> mapToGlobal( this -> password_generator_label -> geometry().center() ).y() ) * 0.65f
        );
        this -> password_generator_label -> setText( "Password Generator" );

        // Comment label
        this -> comment_label = QSharedPointer<QLabel>( 
            new QLabel( this -> host -> host ) 
        );
        ...
        // Length line edit
        this -> length_line_edit = QSharedPointer<QLineEdit>( 
        ...
        // Length label
        this -> length_label = QSharedPointer<QLabel>( 
            new QLabel( this -> host -> host ) 
        );
        ...
        // Upper case label
        this -> uppercase_label = QSharedPointer<QLabel>( 
            new QLabel( this -> host -> host ) 
        );
        ...
        // Lower case label
        this -> lowercase_label = QSharedPointer<QLabel>( 
            new QLabel( this -> host -> host ) 
        );
        ...
        this -> symbols_checkbox -> move(
            this -> separator -> geometry().center().x() + 320.f,
            this -> separator -> geometry().center().y() - 45.f
        );

        // Symbols label
        this -> symbols_label = QSharedPointer<QLabel>( 
            new QLabel( this -> host -> host ) 
        );
        ...
        // Numbers label
        this -> numbers_label = QSharedPointer<QLabel>( 
            new QLabel( this -> host -> host ) 
        );
        ...
        this -> ambiguous_characters_label = QSharedPointer<QLabel>( 
            new QLabel( this -> host -> host ) 
        );
