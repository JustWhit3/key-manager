...
namespace kmanager::state {
     ...
     */
    SetPasswordState::SetPasswordState(QWidget *host, QState *parent) : BaseState(parent), host(host) {
        // Create widgets
        this->addWidgets();
    ...
    void SetPasswordState::addWidgets() {
        ...
        this->enter_password_first = QSharedPointer<QLineEdit>(new QLineEdit(this->host));
        ...
        this->enter_password_first->move(
            ...
            (this->host->mapToGlobal(this->host->geometry().center()).y() -
             this->enter_password_first->mapToGlobal(this->enter_password_first->geometry().center()).y()) *
                1.1f);
        ...
        QObject::connect(this->enter_password_first.get(), SIGNAL(returnPressed()), this, SLOT(savePassword()));

        QObject::connect(this->enter_password_first.get(), SIGNAL(returnPressed()), this, SLOT(savePassword()));

        // Enter second password line edit
        this->enter_password_second = QSharedPointer<QLineEdit>(new QLineEdit(this->host));
        ...
        this->enter_password_second->move(
            ...
            (this->host->mapToGlobal(this->host->geometry().center()).y() -
             this->enter_password_second->mapToGlobal(this->enter_password_second->geometry().center()).y()) *
                1.3f);
        ...
        QObject::connect(this->enter_password_second.get(), SIGNAL(returnPressed()), this, SLOT(savePassword()));

        // Setup first checkbox
        this->checkbox_first = QSharedPointer<QCheckBox>(new QCheckBox(this->host));
        this->checkbox_first->setVisible(false);
        this->checkbox_first->setStyleSheet(this->checkbox_first_style);
        this->checkbox_first->move((this->host->mapToGlobal(this->host->geometry().center()).x() -
                                    this->checkbox_first->mapToGlobal(this->checkbox_first->geometry().center()).x()) *
                                       1.29f,
                                   (this->host->mapToGlobal(this->host->geometry().center()).y() -
                                    this->checkbox_first->mapToGlobal(this->checkbox_first->geometry().center()).y()) *
                                       1.1f);
        this->checkbox_first->setFixedSize(35, 35);

        QObject::connect(this->checkbox_first.get(), SIGNAL(clicked()), this, SLOT(changeToggleState_first()));

        // Setup second checkbox
        this->checkbox_second = QSharedPointer<QCheckBox>(new QCheckBox(this->host));
        ...
        this->checkbox_second->move(
            (this->host->mapToGlobal(this->host->geometry().center()).x() -
             this->checkbox_second->mapToGlobal(this->checkbox_second->geometry().center()).x()) *
                1.29f,
            (this->host->mapToGlobal(this->host->geometry().center()).y() -
             this->checkbox_second->mapToGlobal(this->checkbox_second->geometry().center()).y()) *
                1.29f);
        this->checkbox_second->setFixedSize(35, 35);

        QObject::connect(this->checkbox_second.get(), SIGNAL(clicked()), this, SLOT(changeToggleState_second()));
        ...
        this->user_img_label->move(this->enter_password_second->geometry().x() + 33.f,
        ...
        this->confirm_button->setStyleSheet(
            "font-size: 20px;"
            "border-radius: 11px;");
        this->confirm_button->move(this->enter_password_second->geometry().x(),
                                   this->enter_password_second->geometry().y() * 1.18f);
        this->confirm_button->setFixedSize(
            QSize(this->enter_password_first->geometry().width(), this->enter_password_second->geometry().height()));
        this->confirm_button->setText("Confirm");

        QObject::connect(this->confirm_button.get(), SIGNAL(clicked()), this, SLOT(savePassword()));
    }
