...
namespace kmanager::state{
    ...
    void PasswordInfoState::addWidgets(){
        ...
        this -> title = QSharedPointer<QLabel>(
        ...
        // Strength
        this -> strength_label = QSharedPointer<QLabel>(
            new QLabel( this -> host )
        );
        ...
        // Last update
        this -> last_update_label = QSharedPointer<QLabel>(
            new QLabel( this -> host )
        );
        ...
        this -> last_update_label -> move(
            this -> strength_label -> geometry().x(),
            this -> strength_label -> geometry().y() + 60.f
        );

        // Last update textbox
        this -> last_update_textbox = QSharedPointer<QLineEdit>(
            new QLineEdit( this -> host )
        );
        this -> last_update_textbox -> setVisible( false );
        this -> last_update_textbox -> resize( 
            this -> last_update_label -> geometry().width() * 1.75f,
            this -> last_update_label -> geometry().height()
        );
        this -> last_update_textbox -> setStyleSheet( widget_font_size );
        this -> last_update_textbox -> move(
        ...
        // Creation
        this -> creation_label = QSharedPointer<QLabel>(
            new QLabel( this -> host )
        );
        ...
        this -> creation_label -> move(
            this -> last_update_label -> geometry().x(),
            this -> last_update_label -> geometry().y() + 60.f
        );

        // Creation textbox
        this -> creation_textbox = QSharedPointer<QLineEdit>(
            new QLineEdit( this -> host )
        );
        this -> creation_textbox -> setVisible( false );
        this -> creation_textbox -> resize( 
            this -> creation_label -> geometry().width() * 1.75f,
            this -> creation_label -> geometry().height()
        );
        this -> creation_textbox -> setStyleSheet( widget_font_size );
        this -> creation_textbox -> move(
