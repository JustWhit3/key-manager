...
namespace kmanager::widget {
     ...
     *
     */
    void PasswordActions::setDeleteTrue() { this->deleteMe = true; }
     ...
     *
     */
    void PasswordActions::setSaveMySettingsTrue() { this->saveMySettings = true; }
     ...
     *
     */
    void PasswordActions::setInformationTrue() { this->seeMyInfo = true; }
